...
public class MyBFS {
    ...
    private void doParallelLevel(Direction direction){
        ...
        while(pos<frontierList.size()){
            ...
            if((pos+BATCHSIZE)>=frontierList.size()){
                callable = new MyBFSLevelCallable(pos,frontierList.size(),frontierArray,direction,db);
            } else{
                callable = new MyBFSLevelCallable(pos,pos+BATCHSIZE,frontierArray,direction, db);
            }
    ...
    private void doSequenzialLevel(Direction direction){
        ...
        while(it.hasNext()){
            ...
            newFrontier.addAll(BFS.go(n,direction, db));
        }
        frontierList.clear();
